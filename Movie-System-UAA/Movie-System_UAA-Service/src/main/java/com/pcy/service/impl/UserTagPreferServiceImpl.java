...
import com.pcy.dao.UserTagPreferDao;
...
public class UserTagPreferServiceImpl implements UserTagPreferService {
    ...
    @Resource
    MovieTagFeignApi movieTagFeignApi;
    ...
    public List<MovieTag> queryFullInfoById(Integer userId) {
        ...
        ApiResponse<List<MovieTag>> listApiResponse = this.movieTagFeignApi.queryByIdList(idList);
        System.out.println(listApiResponse);
        return this.movieTagFeignApi.queryByIdList(idList).getData();
    }
}