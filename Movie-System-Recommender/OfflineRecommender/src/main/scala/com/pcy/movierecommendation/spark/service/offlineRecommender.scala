...
import com.pcy.movierecommendation.spark.entity.{BaseRecommendation, MovieRecs, MovieUserRatings, UserRecs}
...
object offlineRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val spark: SparkSession = SparkSession.builder()
      .config(sparkConf)
      .config("com.pcy.movierecommendation.spark.mongodb.input.uri", DBConstant.MONGO_URL)
      .config("com.pcy.movierecommendation.spark.mongodb.output.uri", DBConstant.MONGO_URL)
      //.config("com.pcy.movierecommendation.spark.local.dir", "D:\\usr\\sparkTmpData")
      .getOrCreate()
